...
class UserController extends BaseController
{
		...
		<div style="text-align:center;display:block">
			<div style="max-width:328px;margin:0;padding:0;display:inline-block">
				...
				<div style="margin:0px 8.5px 0px 8.5px">
					...
					<div style="margin-bottom:16px;text-align:left">Terima kasih telah mendaftar. Proses pendaftaran Akun hampir selesai. Ayo segera klik tombol di bawah ini untuk <span class="il">verifikasi</span> email kamu.</div>
				...
				<div style="margin-top:40px;background:#eef2f6;padding:16px 0px 16px 0px">
					...
					<div style="text-align:center;margin:0px 16px 0px 16px;font-style:normal;font-weight:500;font-size:12px"> © '.date("Y").' E-Learning . All Rights Reserved. </div>
				</div>
			</div>
		</div>
	</div>';
    ...
    public function login()
    {
        ...
        "SELECT * from users u where email_address  = 'fazrinursyam@gmail.com' or phone_number = '0895359470789'";
        return $this->response->setJson(["status" => 200, "message" => "Successfully!"]);
