      ...
      <div class="container">
         ...
         <div class="navbar-header">
            ...
            <ul class="nav navbar-nav  navbar-right">
               <li>
                  <a class="to-top" style="font-size: xx-large;">
                     Kelompok II
                  </a>
               </li>
            </ul>
            ...
            <ul>
               ...
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg.jpg" data-delay="10000" data-saveperformance="on" data-title="We Are Visual">
                  ...
                  <div class="tp-caption sft"
                     ...
                     <h2 class="home-heading op-1">  MyBest Cloning</h2>
                  </div>
                  <!-- Home Subheading -->
               ...
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg-1.jpg" data-delay="10000"  data-saveperformance="on" data-title="Digital Agency">
                  ...
                  <div class="tp-caption sft"
                                        ...
                                        data-endspeed="300"
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <h2 class="home-heading op-2"> MyBest Cloning</h2>
                  </div>
                  <!-- Home Subheading -->
               ...
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg-2.jpg" data-delay="10000"  data-saveperformance="on" data-title="Creative Coders">
                  ...
                  <div class="tp-caption sft"
                                        ...
                                        data-endspeed="300"
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <h2 class="home-heading op-3"> MyBest Cloning</h2>
                  </div>
                  <!-- Home Subheading -->
                  <div class="tp-caption home-subheading sft fadeout"
                                        data-x="center" 
...
<div class="site-wrapper content">
   ...
   <section id="team">
      <div class="container">
         <div class="col-md-20 text-center wow fadeInUp">
         ...
         <div id="client-slider" class="owl-carousel">
            <div class="col-md-12 team-member item">
               <div class="effect effects wow fadeInUp">
                  <div class="img">
                     <img src="img/team/cwok.png" class="img-responsive" alt="" />
                     <div class="overlay">
                        <ul class="expand">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>Ahmad Fazri Nursamsi</h4>
                  <h5 class="highlight">17200473</h5>
            ...
            <div class="col-md-12 team-member item">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>YOEL STEADY VALENTINO</h4>
                  <h5 class="highlight">17200348</h5>
                  <!-- <p>Vivamus motestues phasellus enim sed orci eu pharetra.</p> -->
               </div>
            </div>
            <div class="col-md-12 team-member item">
               <div class="effect effects wow fadeInUp">
                  <div class="img">
                     <img src="img/team/cwek.png" class="img-responsive" alt="" />
                     <div class="overlay">
                        <ul class="expand">
                           <li class="social-icon">
                              <a href="#" onClick="return false;">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>DIANNA PUTRI APRILLILIA</h4>
                  <h5 class="highlight">17200936</h5>
                  <!-- <p>Vivamus motestues phasellus enim sed orci eu pharetra.</p> -->
               </div>
            </div>
            <div class="col-md-12 team-member item">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>ARLIYANDO RANDA LINGGI</h4>
                  <h5 class="highlight">17200349</h5>
                  <!-- <p>Vivamus motestues phasellus enim sed orci eu pharetra.</p> -->
               </div>
            </div>
            <div class="col-md-12 team-member item">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>SOLIHUDIN</h4>
                  <h5 class="highlight">17200518</h5>
                  <!-- <p>Vivamus motestues phasellus enim sed orci eu pharetra.</p> -->
               </div>
            </div>
         </div>
   ...
   <footer id="footer">
      ...
      <div class="footer-copyright">
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h3 class="section-title wow fadeInUp">Kelompok II</h3>
                  <p class="wow fadeInUp"> Created by Kelompok II
                  <a href="https://github.com/ahmadfazrinursamsi" target="_blank">Link here</a> 
                  </p>
